...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="intern_rec.html" class="w3-bar-item w3-button w3-hover-white" style="background-color:white;color:black ;width:100%";>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Intern Record</a>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:50px" id="showcase">
    <h1 class="w3-jumbo"><b style="font-size:35px">Internship Record</b></h1>
      </p>
  </div>
