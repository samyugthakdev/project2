...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  <div class="w3-container">
    <h3 class="w3-padding-64"><b>Online Recruitment<br>System</b></h3>
  </div>
  <div class="w3-bar-block">
    ...
    <a href="job_rec.html" class="w3-bar-item w3-button w3-hover-white" style="background-color:white;color:black ;width:100%";>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Recruited Records</a> 
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:50px" id="showcase">
    <h1 class="w3-jumbo"><b style="font-size:35px">Recruited Record</b></h1>
      </p>
  </div>
...
try
{
	...
	ResultSet rs=null;
	rs=st.executeQuery("Select * from cmp_final");
	while(rs.next())
	{
		String dob= rs.getString("cmp_name");
		if(dob.equals("Info tech"))
		{
%>
		  <tr>
		  <td><%=rs.getString("cmp_name") %></td>
		  <td><%=rs.getString("cand_name") %></td>
		  <td><%=rs.getString("reg_type") %></td>
		  </tr>
<%
        }
      }
